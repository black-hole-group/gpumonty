...
extern double *****d_econ;
extern double *****d_ecov;
extern double ****d_bcon;
extern double ****d_bcov;
extern double ****d_ucon;
extern double ****d_ucov;
extern double * d_p;
extern double ***d_ne;
...
double interp_scalar(double *var, int mnemonics, int i, int j, int k, double coeff[8]);
