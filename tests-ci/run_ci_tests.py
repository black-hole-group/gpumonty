...
def ensure_define(filepath, key, value):
    """Ensure a #define has the correct value."""
...
def main():
    ...
    print("Running synchrotron test...")
    run_test(
        "./tests-ci/sphere-emission-test-synchrotron.par",
        "./tests-ci/sphere-emission-test-synchrotron.py",
    )

    print("Running bremsstrahlung test...")
    run_test(
        "./tests-ci/sphere-emission-test-bremsstrahlung.par",
        "./tests-ci/sphere-emission-test-bremsstrahlung.py",
    )

    print("Running mixed emission test...")
    run_test(
        "./tests-ci/sphere-emission-test-mixed.par",
        "./tests-ci/sphere-emission-test-mixed.py",
    )
